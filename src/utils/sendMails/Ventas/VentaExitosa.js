const sendPaymentSuccessEmail = (name, plan, actualDate) => {
  return `
  <!doctype html>
  <html lang="en">
    <head>
                ...
                <tbody>
                  <tr>
                    <td class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;background-color: #ebf5fa;color: #82899a;padding-left: 24px;padding-right: 24px;padding-top: 64px;padding-bottom: 40px;">
                      ...
                      <p style="margin-top: -4px;margin-bottom: 0px; color:#126de5; font-size: 16px;">se ha realizado con éxito</p>
                    </td>
                  </tr>
                </tbody>
              </table>
                          ...
                          >
                            ...
                            >
                              <p style="margin-top: 0px; margin-bottom: 20px">
                                ¡Felicitaciones! Le queremos confirmar que la 
                                suscripción al plan <b>${plan}</b> de MiCole 
                                se ha procesado con éxito a través de Mercado Pago. 
                              </p>
                              <p style="margin-top: 0px; margin-bottom: 20px">
                                Si necesita alguna otra información o tiene alguna 
                                pregunta, no dude en ponerse en contacto nosotros a 
                                través del correo informes@micole.com.pe. 
                              </p>
                              <p style="margin-top: 0px; margin-bottom: 20px">
