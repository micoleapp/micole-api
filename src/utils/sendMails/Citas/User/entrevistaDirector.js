const entrevistaDirector = (user, colegio, actualDate)  => { return `
<!doctype html>
  <html lang="en">
    <head>
      <meta charset="utf-8">
                ...
                <tbody>
                  <tr>
                    <td class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;background-color: #ebf5fa;color: #82899a;padding-left: 24px;padding-right: 24px;padding-top: 64px;padding-bottom: 40px;">
                      ...
                      <h2 class="o_heading o_text-dark o_mb-xxs" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;color: #242b3d;font-size: 30px;line-height: 39px;">¡Felicitaciones!</h2>
                      <p style="margin-top: 14px;margin-bottom: 0px; color:#126de5; font-size: 16px;">Has pasado a la etapa de Aplicación con el Director</p>
                      <p style="margin-top: -4px;margin-bottom: 0px; color:#126de5; font-size: 16px;"> del colegio ${colegio.nombre_colegio}</p>
                    </td>
                  </tr>
                </tbody>
              </table>
                ...
                <tbody>
                  <tr>
                    <td class="o_bg-white o_px-md o_py o_sans o_text-xs o_text-light" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;background-color: #ffffff;color: #82899a;padding-left: 24px;padding-right: 24px;padding-top: 16px;padding-bottom: 16px;">
                      <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px; font-size: 16px"><b>Estimado/a ${user.nombre}:</b></p>
                    </td>
                  </tr>
                </tbody>
              </table>
                          ...
                          >
                            ...
                            >
                              <p style="margin-top: 0px; margin-bottom: 20px">
                                Nos complace informarle que el colegio <b>${colegio.nombre_colegio}</b> 
                                lo ha pasado a la siguiente etapa del proceso de admisión. 
                                Si tiene alguna pregunta o inquietud sobre cómo proceder 
                                puede comunicarse con <b>${colegio.nombre_responsable}</b> 
                                al correo <b>${colegio.Auth.email}</b>. 
                              </p>
                              <p><b>Atentamente,</b></p>
                              <p>
...
module.exports = entrevistaDirector;