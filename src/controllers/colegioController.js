...
const getColegiosAdmin = async (req, res, next) => {
...
const getColegioInfraestructuras =  async (req, res, next) => {
  try {
...
const getColegioAfiliaciones = async (req, res, next) => {
  try {
    const { Colegio_id } = req.params;
    // console.log(Colegio_id);
    const cole = await Colegio.findAll({
...
const getColegioComparador = async (req, res) => {
  try {
    const { Colegio_id } = req.params;
    console.log(Colegio_id);
...
const getColegiosFilter = async (req, res) => {
  const {
    distrits,
    grado,
    tipo,
...
const changeStatusColegio = async (req, res) => {
  const { id } = req.params;
